      ...
      <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Recheche annuel des composants recommandés</h5>
        
                      <form class="row g-3" action="${pageContext.request.contextPath}/composants/recommandes/recherche2" method="post">
                        <div class="col-md-12">
